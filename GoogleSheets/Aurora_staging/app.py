...
#Gluejob settings
#gluejobname = os.environ.get('GlueJob_Name')
...
def drop_table(table_name):
    try:
        ...
        #print("--------------------------------------------------------")
        logger.info("drop table name  "+ table_name)
...
def create_table(table_name, df):
    ...
    #create_table_query = "CREATE TABLE IF NOT EXISTS " + table_name + " ( pk_id bigint NOT NULL AUTO_INCREMENT, upd_user varchar(50) default 'pdl' , upd_date  datetime DEFAULT '"+current_timestamp +"' , "
    # l = ["Referral Partner Lookup","3CLogic_Names","Campaign Performance Funnels","Enrollment Team Names","Opportunity Lead Types"]
    # if table_name in l:
    #     create_table_query = "CREATE TABLE IF NOT EXISTS " + table_name + " (id bigint NOT NULL AUTO_INCREMENT, upd_user varchar(50) default 'pdl' , upd_date  datetime DEFAULT '"+current_timestamp +"' , "
    # else:
    #     create_table_query = "CREATE TABLE IF NOT EXISTS " + table_name + " ( upd_user varchar(50) default 'pdl' , upd_date  datetime DEFAULT '"+current_timestamp +"' , "
    ...
    try:
        ...
        create_table_query += ");"
       # create_table_query += ", PRIMARY KEY (pk_id));"
...
def insert_data(table_name, df):
    try:
        ...
        if len(values) > 0:
            ...
            mysql_client.commit()
            print("--------------------Success inserting data --------------------------  "+ table_name )
    except Exception as e:
...
def handler(event, context):
    ...
    publish_to_aurora()
    logger.info("----Ended----")
    print("-----GoogleSheets_to_Aurora_Staging_Ended-----")
    #user = gluejob(event)
    print("Successfull")
    return "Successfull"
